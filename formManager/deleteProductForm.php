...
<body>
    ...
    <div class="form-wrapper">
        <form class="formmat" method="post" action="../php/manager/deleteProduct.php">
            ...
            <a href="../page/inventorymanager.php"><input type="button" name="No_Delete" value="No" class="button"></a>
        </form>
    </div>
